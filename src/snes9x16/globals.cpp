/*
 * Device build: the large globals for features this port does not build are
 * omitted. Together they are 1.04 MB of bss - 71% of the core's static
 * footprint - against 520 KB of SRAM on the RP2350:
 *
 *   Cheat  893980   cheat engine, not built
 *   DSP3    50296   coprocessor, not built
 *   SA1     32856   coprocessor, not built
 *
 * Guarded rather than deleted so the file still diffs cleanly against
 * upstream.
 */
#ifndef SNES9X_NO_CHEATS
#define SNES9X_NO_CHEATS 0
#endif
#ifndef SNES9X_NO_DSP3
#define SNES9X_NO_DSP3 0
#endif
#ifndef SNES9X_NO_SA1
#define SNES9X_NO_SA1 0
#endif
