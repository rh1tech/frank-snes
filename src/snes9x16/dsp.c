...
#include "port.h"
#ifndef SNES9X_NO_DSP3
#define SNES9X_NO_DSP3 0
#endif
#include "dsp.h"
...
#if !SNES9X_NO_DSP3
/* DSP-3 is 49 KB of working state (three 0x2000 int16 planes) for two
   obscure games, against 520 KB of SRAM. The shipping 1.43 firmware
   already compiles all four DSP coprocessors out - its DSP1..DSP4
   globals are 4 bytes each - so leaving this out regresses nothing. */
/***********************************************************************************
 DSP3
***********************************************************************************/
